...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _calculationsCreator = __webpack_require__(2);

	var _calculationsCreator2 = _interopRequireDefault(_calculationsCreator);
	...
	_reactDom2.default.render(_react2.default.createElement(_calculationsCreator2.default, null), document.getElementById('js-create-calculations'));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Operation = function (_React$Component) {
	  ...
	  function Operation() {
	    ...
	    return _possibleConstructorReturn(this, (Operation.__proto__ || Object.getPrototypeOf(Operation)).call(this));
	  }
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          "label",
	          { htmlFor: "operator_value_" + i },
	          "Operator:"
	        ),
	        _react2.default.createElement(
	          "select",
	          { name: "operator_value_" + i, id: "operator_value_" + i },
	          _react2.default.createElement(
	            "option",
	            { key: "operator_value_" + i + "-plus", value: "+" },
	            "+ (plus)"
	          ),
	          _react2.default.createElement(
	            "option",
	            { key: "operator_value_" + i + "-minus", value: "-" },
	            "- (minus)"
	          ),
	          _react2.default.createElement(
	            "option",
	            { key: "operator_value_" + i + "-multiply", value: "*" },
	            "* (multiply)"
	          ),
	          _react2.default.createElement(
	            "option",
	            { key: "operator_value_" + i + "-divide", value: "/" },
	            "/ (divide)"
	          ),
	          _react2.default.createElement(
	            "option",
	            { key: "operator_value_" + i + "-power", value: "^" },
	            "^ (to power of)"
	          )
	        )
	      );
	...
	var FormulaValue = function (_React$Component2) {
	  _inherits(FormulaValue, _React$Component2);

	  function FormulaValue() {
	    _classCallCheck(this, FormulaValue);

	    var _this2 = _possibleConstructorReturn(this, (FormulaValue.__proto__ || Object.getPrototypeOf(FormulaValue)).call(this));

	    _this2.state = {
	      type: 'static_value'
	    };
	    _this2.handleToggleChange = _this2.handleToggleChange.bind(_this2);
	    return _this2;
	  }

	  _createClass(FormulaValue, [{
	    key: "handleToggleChange",
	    value: function handleToggleChange(event) {
	      this.setState({ type: event.target.value });
	    }
	  }, {
	    key: "renderStaticInput",
	    value: function renderStaticInput() {
	      var i = this.props.count;
	      return _react2.default.createElement(
	        "div",
	        null,
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                "label",
	                { className: "toggle", htmlFor: "value_type_static_" + i },
	                "Static value"
	              )
	            ),
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                "label",
	                { className: "toggle", htmlFor: "value_type_object_" + i },
	                "Value from object"
	              )
	            )
	          )
	...
	var CalculationsCreator = function (_React$Component3) {
	  _inherits(CalculationsCreator, _React$Component3);

	  function CalculationsCreator(props) {
	    _classCallCheck(this, CalculationsCreator);

	    var _this3 = _possibleConstructorReturn(this, (CalculationsCreator.__proto__ || Object.getPrototypeOf(CalculationsCreator)).call(this, props));
	    ...
	    _this3.handleAddOperation = _this3.handleAddOperation.bind(_this3);
	    _this3.handleObjSelect = _this3.handleObjSelect.bind(_this3);
	    return _this3;
	  }

	  _createClass(CalculationsCreator, [{
	    key: "fetchUrl",
	    ...
	    value: function componentDidMount() {
	      ...
	      this.fetchUrl('http://127.0.0.1:5000/api/prototypes/read').then(function (data) {
	        var objects = [];
	        for (var key in data) {
	        ...
	        _this4.setState({ objects: objects });
	      });
	    }
	  }, {
	    key: "handleAddOperation",
	    value: function handleAddOperation(e) {
	      e.preventDefault();
	      this.setState({
	    ...
	    key: "handleObjSelect",
	    value: function handleObjSelect(event) {
	      var obj = this.state.objects.filter(function (object) {
	    ...
	    value: function render() {
	      ...
	      for (var i = 0; i < this.state.inputs; i++) {
	        if (i == 0) {
	          formulas.push(_react2.default.createElement(FormulaValue, { count: i, selectedObj: this.state.selectedObj }));
	          formulas.push(_react2.default.createElement(Operation, { count: i }));
	          formulas.push(_react2.default.createElement(FormulaValue, { count: i + 1, selectedObj: this.state.selectedObj }));
	        } else {
	          formulas.push(_react2.default.createElement(Operation, { count: i }));
	          formulas.push(_react2.default.createElement(FormulaValue, { count: i + 1, selectedObj: this.state.selectedObj }));
	        }
	      ...
	      return _react2.default.createElement(
	        "form",
	        { method: "post", action: "/prototypes/_incoming", encType: "multipart/form-data" },
	        _react2.default.createElement(
	          "label",
	          { htmlFor: "name" },
	          "Calculation name:"
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            "label",
	            { htmlFor: "object" },
	            "Directly on prototype (always calculated):"
	          ),
	          _react2.default.createElement(
	            "select",
	            { name: "object",
	            ...
	            this.state.objects.map(function (object, i) {
	              return _react2.default.createElement(
	                ...
	                {
	                  value: object.type,
	                  selected: _this5.state.selectedObj.type === object.type,
	                  key: "object_" + i },
	                object.type
	              );
	            })
	        ...
	        _react2.default.createElement(
	          "a",
	          { className: "usa-button usa-button-outline", onClick: this.handleAddOperation },
	  ...
	  return CalculationsCreator;
	}(_react2.default.Component);

	;

	exports.default = CalculationsCreator;
