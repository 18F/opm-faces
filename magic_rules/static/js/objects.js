...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _objectCreator = __webpack_require__(2);
	...
	_reactDom2.default.render(_react2.default.createElement(_objectCreator2.default, null), document.getElementById('js-create-object'));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ObjectCreator = function (_React$Component) {
	  _inherits(ObjectCreator, _React$Component);

	  function ObjectCreator(props) {
	    _classCallCheck(this, ObjectCreator);

	    var _this = _possibleConstructorReturn(this, (ObjectCreator.__proto__ || Object.getPrototypeOf(ObjectCreator)).call(this, props));

	    _this.state = {
	      inputs: [{ 'name': 'attribute_1' }]
	    };
	    _this.handleAddAttribute = _this.handleAddAttribute.bind(_this);
	    return _this;
	  }

	  _createClass(ObjectCreator, [{
	    key: 'handleAddAttribute',
	    value: function handleAddAttribute(e) {
	      e.preventDefault();
	      var newInputName = 'attribute_' + this.state.inputs.length;
	      this.setState({
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        this.state.inputs.map(function (input, i) {
	          return _react2.default.createElement(
	            'div',
	            { className: 'attribute', key: i },
	            _react2.default.createElement(
	              'label',
	              { htmlFor: 'attribute_' + (i + 1) },
	              'Attribute:'
	            ),
	        ...
	        _react2.default.createElement(
	          'a',
	          { className: 'usa-button usa-button-outline', onClick: this.handleAddAttribute },
